...
- `ratatui`: 0.29.0 → 0.30.0 ([#216](https://github.com/CramBL/mdns-scanner/pull/216))
- `insta`: 1.44.3 → 1.45.1 ([#216](https://github.com/CramBL/mdns-scanner/pull/216))
- `tui-popup`: 0.6.2 → 0.7.2 ([#216](https://github.com/CramBL/mdns-scanner/pull/216))
