...
- `tikv-jemallocator`: 0.6.1 → 0.7.0 ([#287](https://github.com/CramBL/mdns-scanner/pull/287))
- `axoupdater`: 0.10.0 → 0.10.2 ([#287](https://github.com/CramBL/mdns-scanner/pull/287))
- `thiserror`: 2.0.18 → 2.0.20 ([#287](https://github.com/CramBL/mdns-scanner/pull/287))
- `clap`: 4.6.2 → 4.6.6 ([#287](https://github.com/CramBL/mdns-scanner/pull/287))
